...
class User(AbstractUser):
    ...
    is_report_viewer = models.BooleanField(default=False)
    ...
    def get_user_roles(self):
        ...
        if self.is_cashier:
            roles.append("is_cashier")
        if self.is_supervisor:
            roles.append("is_supervisor")
        if self.is_report_viewer:
            roles.append("is_report_viewer")
